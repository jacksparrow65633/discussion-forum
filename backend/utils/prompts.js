const postIdeasPrompt = (topic) => `
    Generate a list of 5 post ideas related to ${topic}.
For each Post idea, return:
- a title
- a 2-line description about the post
- 3 relevant tags
- the tone (e.g., technical, causal, beginner-freidnly, etc.)
...
function generateReplyPrompt(comment) {
    ...
    return `You're replying to a post comment by ${authorName}. The comment says:
...
const postSummaryPrompt = (postContent) => (`
    You are an AI assistant that summarizes blog posts.

    Instructions:
    - Read the post content below.
    - Generate a short, catchy, SEO-friendly title (max 12 words).
    - Write a clear, enaging summary of about 300 words.
    ...
    module.exports = { postIdeasPrompt, generateReplyPrompt, postSummaryPrompt };